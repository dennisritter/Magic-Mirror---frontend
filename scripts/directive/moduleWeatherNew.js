...
angular.module('perna').directive('moduleWeather', ['routes', function (routes) {
  return {
    ...
    controller: ['$scope', 'WeatherService', 'LocationService', 'LiveviewService', 'ModuleModalService',
...
angular.module('perna').controller('ModuleWeatherEditController', ['LocationService', '$scope', 'close', 'location',
